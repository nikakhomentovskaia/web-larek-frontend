...
- counter — счетчик, отображающий количество товаров в корзине.
- catalog — каталог товаров, представленный в виде DOM-разметки.
- locked — флаг, который блокирует возможность прокрутки страницы в определённых условиях.
